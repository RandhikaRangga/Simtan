...
<div class="row">
    <div class="col-sm-6">
        <h3 class="mb-0">Laporan Data Panen Kabupaten Tegal</h3>
    </div>
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-end">
            <li class="breadcrumb-item"><a href="PetugasKantor">Dashboard</a></li>
            <li class="breadcrumb-item active" aria-current="page">Laporan Data Panen</li>
        </ol>
    </div>
</div>
<!--end::Row-->
    ...
    <div class="card mb-4">
        <div class="card">
            <div class="card-body">
                <!-- Filter -->
                <div class="no-print">
                    <form method="GET" action="<?= base_url('laporanpanen/view_petugaskantor') ?>" class="mb-3">
                        <div class="row align-items-end">
                            ...
                            <div class="col-md-2">
                                ...
                                <select name="kecamatan" id="kecamatan" class="form-select">
                                    ...
                                    <option value="<?= $k->id ?>"
                                        <?= ($k->id == $selected_kecamatan) ? 'selected' : '' ?>>
                                        <?= $k->kecamatan ?>
                                    </option>
                                    <?php endforeach; ?>
                                </select>
                    ...
                    <!-- Tombol Ekspor & Print -->
                    <div class="mb-3">
                        <form method="POST" action="<?= base_url('laporanpanen/convert_excel') ?>" class="d-inline">
                ...
                <div id="area_cetak">
                    <div class="only-print">
                        <h3 style="text-align: center;">Laporan Data Panen Kabupaten Tegal</h3>
                        <div class="print-row">
