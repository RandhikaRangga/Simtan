...
<div class="row">
    <div class="col-sm-6">
        <h3 class="mb-0">Laporan Data Produksi Kabupaten Tegal</h3>
    </div>
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-end">
            <li class="breadcrumb-item"><a href="<?= base_url('PetugasKantor'); ?>">Dashboard</a></li>
            <li class="breadcrumb-item active">Laporan Data Produksi</li>
        </ol>
    </div>
</div>
<!--end::Row-->
<div class="col-md-12 p-3">
    <div class="card mb-4">
        <div class="card-body">
            <!-- Filter Data -->
            <div class="no-print">
                <form method="GET" action="<?= base_url('laporanproduksi/view_petugaskantor') ?>" class="mb-3">
                ...
                <!-- Tombol Ekspor & Print -->
                <div class="mb-3">
                    <form method="POST" action="<?= base_url('laporanproduksi/convert_excel') ?>" class="d-inline">
            ...
            <div id="area_cetak">
                <div class="only-print">
                    <h3 style="text-align: center;">Laporan Data Produksi Kabupaten Tegal</h3>
                    <div class="print-row">
