...
<div class="row">
    <div class="col-sm-6">
        <h3 class="mb-0">Data Komoditas Tanaman</h3>
    </div>
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-end">
            <li class="breadcrumb-item"><a href="Admin">Dashboard</a></li>
            <li class="breadcrumb-item active" aria-current="page">Data Komoditas</li>
        </ol>
    </div>
</div>
<!--end::Row-->
    ...
    <div class="card mb-4">
        <div class="card">
            <div class="p-3 d-md-flex flex-wrap gap-2 justify-content-md-start justify-content-center">
                <a href="<?= base_url('Admin-TambahKomoditas'); ?>" class="col-6 col-md-auto mb-4">
                    <button type="button" class="btn btn-primary w-100 w-md-auto">
                        <i class="fa-solid fa-plus"></i> Tambah Data Komoditas
                    </button>
                </a>
            </div>
            <div class="card-body">
