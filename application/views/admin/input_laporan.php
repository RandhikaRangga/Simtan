    ...
    <div class="card mb-4">
        <div class="card">
            <div class="p-3 d-md-flex flex-wrap gap-2 justify-content-md-start justify-content-center">
                <a href="<?= base_url('Admin-TambahLaporan'); ?>" class="col-12 col-md-auto mb-8">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="<?= site_url('Admin-EditLaporan/' . $row->batch_id) ?>"
                                    ...
                                    <a href="<?= site_url('Admin-HapusLaporan/' . $row->batch_id); ?>"
                                        class="d-block d-md-inline-block mb-2 mb-md-0">
