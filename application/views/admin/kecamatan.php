...
<div class="row">
    <div class="col-sm-6">
        <h3 class="mb-0">Data Kecamatan Kabupaten Tegal</h3>
    </div>
    <div class="col-sm-6">
    ...
    <div class="card mb-4">
        <div class="card">
            <div class="p-3 d-md-flex flex-wrap gap-2 justify-content-md-start justify-content-center">
                <a href="<?= base_url('Admin-TambahKecamatan'); ?>" class="col-6 col-md-auto mb-4">
                    <button type="button" class="btn btn-primary w-100 w-md-auto">
                        <i class="fa-solid fa-plus"></i> Tambah Data Kecamatan
                    </button>
                </a>
            </div>
            <div class="card-body">
