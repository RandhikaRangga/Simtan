...
<div class="row">
    <div class="col-sm-6">
        <h3 class="mb-0">Tabel Tanam Kabupaten Tegal</h3>
    </div>
    <div class="col-sm-6">
                ...
                <div class="row align-items-end">
                    ...
                    <div class="col-md-2">
                        ...
                        <select name="kecamatan" id="kecamatan" class="form-select">
                            <option value="all" <?= ($selected_kecamatan == 'all') ? 'selected' : '' ?>>Semua Kecamatan
                            </option>
                    ...
                    <div class="col-md-2">
                        ...
                        <select name="desa" id="desa" class="form-select">
                            <option value="all" <?= ($selected_desa == 'all') ? 'selected' : '' ?>>Pilih Desa</option>
