...
<div class="row">
    <div class="col-sm-6">
        <h3 class="mb-0">Data Panen Kabupaten Tegal</h3>
    </div>
    <div class="col-sm-6">
    ...
    <div class="card mb-4">
        <div class="card">
            <div style="padding: 10px; display:flex; justify-content:flex-start;">
                <button type="button" class="btn btn-primary" style="width: 300px;"><i class="fa-solid fa-plus"></i>
                    Tambah
                    Data
                    Panen</button>
            </div>
            <div class="card-body">
                <table id="panen" class="table table-hover table-bordered">
                    <thead>
