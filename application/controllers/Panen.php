...
class Panen extends CI_Controller {
    ...
    public function view_admin() {
        ...
        $penyuluh_list = $this->Panen_model->get_penyuluh();
    
        // Ambil data panen berdasarkan filter
        $data_panen = $this->Panen_model->get_data_panen($bulan, $tahun, $kecamatan, $desa, $penyuluh);
    ...
    public function view_penyuluh() {
        ...
        $this->load->view('penyuluh/panen', $data);
